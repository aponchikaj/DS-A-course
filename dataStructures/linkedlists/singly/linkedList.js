...
var SinglyListNode = /** @class */ (function () {
...
var SinglyLinkedList = /** @class */ (function () {
    ...
    SinglyLinkedList.prototype.add = function (data) {
        var newNode = new SinglyListNode(data);
        if (!this.head) {
            this.head = newNode;
        }
        else {
    ...
    SinglyLinkedList.prototype.deleteByVal = function (value) {
        if (!this.head) {
    ...
    SinglyLinkedList.prototype.deleteByIndex = function (index) {
    ...
    SinglyLinkedList.prototype.countNodes = function () {
        if (!this.head) {
    ...
    SinglyLinkedList.prototype.fromArr = function (arr) {
